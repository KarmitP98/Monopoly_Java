...
public class Dashboard extends javax.swing.JFrame {
     ...
     */
    public int w,h;
    public ImageIcon backgroundImage = new ImageIcon("Icons/Miscellaneous/buttons/BG.png");
    private ScreenUtil su = new ScreenUtil();

    public Dashboard() {
        initComponents();

        this.setExtendedState(MAXIMIZED_BOTH);
        this.w = (int) this.su.getScreenWidth();
        this.h = (int) this.su.getScreenHeight();
        bk.setSize(this.w, this.h);
        bkpanel.setSize(this.w, this.h);
        bk.setIcon(this.su.convertImageToScreenSize(this.backgroundImage));
    }
